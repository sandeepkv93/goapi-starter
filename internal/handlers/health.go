...
func HealthCheck(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		utils.RespondWithError(w, http.StatusServiceUnavailable, "Database connection error")
		return
	}
	...
	if err := sqlDB.Ping(); err != nil {
		...
		utils.RespondWithError(w, http.StatusServiceUnavailable, "Database ping failed")
		return
	}
